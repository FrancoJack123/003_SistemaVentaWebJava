...
<body>
	...
	<div class="sidebar close">
		...
		<ul class="nav-links">
			<li><a href="servletdashboa" onclick="redirigirOtraPagina(event, this)"> <i class='bx bx-grid-alt'></i>
					<span class="link_name">Dashboard</span>
			</a>
				<ul class="sub-menu blank">
					<li><a type="submit" class="link_name" href="servletdashboa" onclick="redirigirOtraPagina(event, this)">Dashboard</a></li>
				</ul></li>
			<li><a href="servletUsuar?ejecutar=listar&incial=" onclick="redirigirOtraPagina(event, this)"> <i
					class='bx bxs-user'></i><span class="link_name"> Usuarios</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name"
						href="servletUsuar?ejecutar=listar&incial=" onclick="redirigirOtraPagina(event, this)">Usuarios</a></li>
				</ul></li>
			<li><a href="servletclient?ejecutarClientes=listar&incial=" onclick="redirigirOtraPagina(event, this)">
					<i class='bx bxs-group'></i><span class="link_name">Clientes</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name"
						href="servletclient?ejecutarClientes=listar&incial=" onclick="redirigirOtraPagina(event, this)">Clientes</a></li>
				</ul></li>
			<li><a href="servletProduct?ejecutar=listar&incial=" onclick="redirigirOtraPagina(event, this)"> <i
					class='bx bx-archive'></i> <span class="link_name">Productos</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name"
						href="servletProduct?ejecutar=listar&incial=" onclick="redirigirOtraPagina(event, this)">Productos</a></li>
				</ul></li>
			<li><a href="servletUsuar?ejecutar=listarInactivos" onclick="redirigirOtraPagina(event, this)"> <i
					class='bx bxs-error-circle'></i> <span class="link_name">Inactivos</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name"
						href="servletUsuar?ejecutar=listarInactivos" onclick="redirigirOtraPagina(event, this)">Inactivos</a></li>
				</ul></li>
			<li><a href="servletpedido?ejecutar=listarNuevo" onclick="redirigirOtraPagina(event, this)"> <i
					class='bx bx-cart-alt'></i> <span class="link_name"> Pedidos</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name" href="servletpedido?ejecutar=listarNuevo" onclick="redirigirOtraPagina(event, this)">
							Pedidos</a></li>
				</ul></li>
			<li><a href="servletpedido?ejecutar=listadoPedido&incial=" onclick="redirigirOtraPagina(event, this)"> <i class='bx bxs-report'></i> <span class="link_name"> Reportes</span>
			</a>
				<ul class="sub-menu blank">
					<li><a class="link_name" href="servletpedido?ejecutar=listadoPedido&incial=" onclick="redirigirOtraPagina(event, this)">
							Reportes</a></li>
				</ul></li>
			<li>
							...
							<form action="servletpedido">
								...
								<div class="d-flex justify-content-end align-items-center gap-2">
									...
									<div class="mb-3 d-flex gap-2 align-items-center">
										...
										<a type="submit" class="btn btn-danger" onclick="EliminarTodo()">Cancelar</a>
									</div>
								</div>
							</form>
						</div>
	...
	<script type="text/javascript">
		...
		function redirigirOtraPagina(event, element) {
		    event.preventDefault();

		    var confirmacion = confirm("¿Estás seguro de que deseas abandonar la página? ¡Ojo, se borrará todo!");
		    ...
		    if (confirmacion) {
		        ...
		        if (href) {
		            $.ajax({
		                url: document.getElementById('idFormElimina').action,
		                type: 'POST',
		                data: $('#idFormElimina').serialize(),
