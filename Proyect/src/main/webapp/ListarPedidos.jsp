...
<body>
	...
	<section class="home-section">
		...
		<div class="m-4" style="height: 500px;">
			<div class="row mb-3">
				<div class="col">
					<a href="servletpedido?ejecutar=listar" class="btn btn-warning">Agregar</a>
				</div>
				<div class="col">
			...
			<table id="tablaProductos" class="table table-striped table-bordered">
				...
				<tbody>
					<c:forEach items="${listaPed}" var="x">
						<tr>
							<td>${x.codPedido}</td>
							<td>${x.cliente.nombre} ${x.cliente.apellidos}</td>
							<td>${x.usuario.nombre} ${x.usuario.apellidos}</td>
							<td>${x.monto}</td>
							<td>${x.fecha}</td>
							<td class=" fw-bold">${x.estado}</td>
							<td style="text-align: center;">
								...
								<a class="btn btn-secondary" href="servletpedido?ejecutar=generarReporte&codigo=${x.codPedido}" target="_blank">Boleta</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
